...
if __name__ == '__main__':
    ...
    imgpath = '/home/dataset/pendi/abnormal/V1230_2.jpg'
    ...
    for i, mask_ratio in enumerate(mask_ratios):
        ...
        run_one_image(imgpath, model_pre,mask_ratio)

        model_pre = models_mae.__dict__[args.pre_model](norm_pix_loss=False, guide_mask=False)
        run_one_image(imgpath, model_pre, mask_ratio)