...
def plt_cam(model, img_path, target_category=0, target_layers=None):
    ...
    target_layers = [model.blocks[-1].norm1] if not target_layers else target_layers
...
img_path = r'testPic/4.jpg'
plt_cam(model, img_path, target_category=target_category)

savePath = 'model_save/WOGP_75'
model_wo = torch.load(savePath + 'max')
plt_cam(model_wo, img_path, target_category=target_category)